...
const AllJobs = () => {
    ...
    useEffect(()=>{
      axios.get('https://jlback.onrender.com/privatejob').then(res=>setData(res.data))
    },[])
  ...
  return (
    ...
    <NavLink to='/PrivateJobs' className='img2' data-title='Private Jobs'><img src='private_job.png' alt='private jobs'/></NavLink>
